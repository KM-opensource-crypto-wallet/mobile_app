...
export const lightTheme = {
  ...
  // Text fields are a solid surface, not glass: a translucent fill picks up the
  // warm background gradient and reads as cream rather than white.
  inputFill: '#FFFFFF',
  inputBorder: 'rgba(26, 22, 19, 0.08)',
  glassHighlight: 'rgba(26, 22, 19, 0.06)',
  sheetBg: 'rgba(255, 255, 255, 0.92)',
  sheetEdge: 'rgba(26, 22, 19, 0.06)',
  sheetShadow: 'rgba(0, 0, 0, 0.25)',
  disabledSurface: 'rgba(26, 22, 19, 0.12)',
  disabledText: 'rgba(26, 22, 19, 0.35)',
